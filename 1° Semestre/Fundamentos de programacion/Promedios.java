...
public class Promedios {
    public static void main(String[] args) {
        byte i;
           for(i=0;i<3;i++){//Generamos el metodo principal
